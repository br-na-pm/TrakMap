TYPE
	...
	McAdvVelCtrlParType : STRUCT
		Acceleration : REAL; (*Maximum acceleration [Measurement units/s淫*)
		Deceleration : REAL; (*Maximum deceleration [Measurement units/s淫*)
		Jerk : REAL; (*Maximum jerk [Measurement units/s設*)
	END_STRUCT;
	...
	McAdvCamInParType : STRUCT
		...
		Acceleration : REAL; (*Acceleration which is used for the movement to the start position [Measurement units of slave/s淫*)
		Deceleration : REAL; (*Deceleration which is used for the movement to the start position [Measurement units of slave/s淫*)
		Jerk : REAL; (*Maximum jerk during the "move to start" movement [Measurement units of slave/s設*)
	END_STRUCT;
	...
	McCamAutCompParType : STRUCT
	    ...
	    MaxSlaveCompAccel1 : REAL; (*Maximum acceleration of the slave axis during compensation phase 1 [Measurement units of slave/s淫*)
	    MaxSlaveCompAccel2 : REAL; (*Maximum acceleration of the slave axis during compensation phase 2 [Measurement units of slave/s淫*)
	    SlaveCompJoltTime : REAL; (*Jerk time of the slave axis during compensation [s]*)
	    SlaveCompJerk : REAL; (*Jerk of the slave axis during compensation [Measurement units of slave/s設*)
	END_STRUCT;
	...
	McAdvCalcCamFromPointsParType : STRUCT
 	...
 	McAdvCamInLeadInOutParType : STRUCT
		...
		Jerk : REAL; (*Maximum jerk of the slave axis [Measurement units of slave/s設*)
	END_STRUCT;
	...
	McAdvBrCamInParType : STRUCT
		...
		MasterMaxVelocity : REAL; (*Maximum velocity of the master axis [Measurement units of master/s]*)
		Jerk : REAL; (*Maximum jerk of the slave axis [Measurement units of slave/s設*)
		Deceleration : REAL; (*Maximum deceleration [Measurement units of slave/s淫*)
	END_STRUCT;
